...
Game.create!(name: 'Settlers of Catan', type: 'board', pic: 'http://www.pic1.com', description: 'something1', rules_url: 'http://www.rules1.com', duration: '1hr', players: '2-4')
Game.create!(name: 'Monopoly', type: 'board', pic: 'http://www.pic2.com', description: 'something2', rules_url: 'http://www.rules2.com', duration: '1hr', players: '2-4')
Game.create!(name: 'Love Letter', type: 'card', pic: 'http://www.pic3.com', description: 'something3', rules_url: 'http://www.rules3.com', duration: '1hr', players: '2-4')
Game.create!(name: 'Cards of Humanity', type: 'card', pic: 'http://www.pic4.com', description: 'something4', rules_url: 'http://www.rules4.com', duration: '1hr', players: '2-4')
